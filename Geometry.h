...
public:
    ...
    qreal get_rightX_for8Polygon(int x, int d);
    qreal get_leftX_for8Polygon(int x, int d);
    qreal getLeftAngle(int x, int y, int width, int height);
    qreal getRightAngle(int x, int y, int width, int height);
};
